...
const rows = [
  { id: 'userPhoto', numeric: false, disablePadding: true, label: 'Profile Picture' },
  { id: 'userID', numeric:  true, disablePadding: false, label: 'User ID' },
  { id: 'userName', numeric: true, disablePadding: false, label: 'Display Name' },
  { id: 'userEmail', numeric: true, disablePadding: false, label: 'Email' },
...
class EnhancedTable extends Page {
  constructor(props) {
    super(props);
    this.state = {
      order: 'asc',
